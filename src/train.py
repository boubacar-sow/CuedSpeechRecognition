...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_features_dir', type=str, default='/pasteur/appa/homes/bsow/ACSR/ACSR/data/training_features', help='Directory for training features')
    parser.add_argument('--train_labels_dir', type=str, default='/pasteur/appa/homes/bsow/ACSR/ACSR/data/train_labels', help='Directory for training labels')
    parser.add_argument('--val_features_dir', type=str, default='/pasteur/appa/homes/bsow/ACSR/ACSR/data/val_features', help='Directory for validation features')
    parser.add_argument('--val_labels_dir', type=str, default='/pasteur/appa/homes/bsow/ACSR/ACSR/data/val_labels', help='Directory for validation labels')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='/pasteur/appa/homes/bsow/ACSR/ACSR/checkpoints', help='Directory to save checkpoints')
    parser.add_argument('--checkpoint_path', type=str, default='/pasteur/appa/homes/bsow/ACSR/ACSR/checkpoints/best_model.pt', help='Path to load a checkpoint to resume training')
